 ...
 */
public class AvrdudeMacCommand {
    /**
     ...
     */
    public AvrdudeMacCommand(final String basepath, final String port, final String tempFile, final String baudRate) {
    ...
    public AvrdudeMacCommand(final String basepath, final String port, final String tempFile, final String maximumSize, final String protocol, final String baudRate, final String board) {
        flashCommand.append("").append(basepath).append("avrdude ")
                .append(" -C ").append(basepath).append("avrdude.conf ")
                .append(" -P ").append(port)
